...
INSERT INTO [dbo].[Company] ([CompanyId], [CompanyName], [Address], [Address1], [SoftwareName], [PhoneNumber], [Motto]) VALUES (1, N'Grenreal', N'Bruce Street', N'St. George''s', N'QicTick', N'435-8372', N'Property Corperation Ltd')
SET IDENTITY_INSERT [dbo].[Company] OFF



SET IDENTITY_INSERT [dbo].[Stores] ON
INSERT INTO [dbo].[Stores] ([StoreId], [StoreCode], [StoreAddress], [CompanyId], [TransactionSeed], [SeedTransaction]) VALUES (1, N'G2', N'Gate 2', 1, 0, 0)
SET IDENTITY_INSERT [dbo].[Stores] OFF

SET IDENTITY_INSERT [dbo].[Stations] ON
INSERT INTO [dbo].[Stations] ([StationId], [StationCode], [StoreId], [ReceiptPrinterName], [MachineName], [PrintServer]) VALUES (1, N'G1', 1, N'Star TSP100 Cutter (TSP143)', N'Alphaquest-PC', NULL)
