...
-- --------------------------------------------------
-- Date Created: 01/06/2013 14:07:07
-- Generated from EDMX file: D:\Prism Projects\QicTic\PrismApplication1\RMSDataAccessLayer\QuickSales.edmx
-- --------------------------------------------------
...
GO
IF OBJECT_ID(N'[dbo].[DiscountCoupons]', 'U') IS NOT NULL
    DROP TABLE [dbo].[DiscountCoupons];
GO
...
-- Creating table 'DiscountCoupons'
...
-- Creating primary key on [DiscountCouponId] in table 'DiscountCoupons'
ALTER TABLE [dbo].[DiscountCoupons]
ADD CONSTRAINT [PK_DiscountCoupons]
    PRIMARY KEY CLUSTERED ([DiscountCouponId] ASC);
GO
